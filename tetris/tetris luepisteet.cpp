...
void TallennaPisteet(int pisteet, HIGHSCORE huippupisteet);
void LuePisteet();
...
void TallennaPisteet(int pisteet, HIGHSCORE huippupisteet)
{
	...
	cout << "Anna nimesi: ";
	cin >> huippupisteet.nimi;
	huippupisteet.score = pisteet;
	for (int i = 0; i < 1; i++)
	{
		kirjoitus << "\"NIMI\"" << ":" << huippupisteet.nimi << endl;
		kirjoitus << "\"PISTEET\"" << ":" << huippupisteet.score;
		kirjoitus << "\"PAIVAMAARA\"" << ":" << __DATE__;
	}
	kirjoitus.close();
}
